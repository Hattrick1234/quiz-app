...
INSERT INTO "new_QuizSetting" ("askingOrder", "difficultSetting", "id", "order", "quizId", "readOption", "userId") SELECT "askingOrder", "difficultSetting", "id", "order", "quizId", "readOption", "userId" FROM "QuizSetting";
